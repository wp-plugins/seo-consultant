...
** Things to know before you use seo consultant **
 
Even though all those SEO Tools usually cost a couple of hundrend bucks per month, our SEO Consultant WordPress Plugin provides all those features for FREE!
...
Currently we noticed that SEO Consultant has a problem with the proper parsing of nofollow/dofollow links + Anchor Text Distribution (it shows empty). This is a bug that we're currently trying to fix. Any other bugs or suggestions can be made throught our FB Group <https://www.facebook.com/groups/ifeedgr/>